...
import wx.lib.mcow.shapedbitmapbutton
...
def GetDemos():
    ...
    UsersTreeItem = "ShapedBitmapButton"

    # The MCow demos
    UsersDemos = ['ShapedBitmapButton',
                  'ShapedBitmapButton_OnTopOfAnother',
                  'ShapedBitmapButton_ShapedWindow',
                  'ShapedBitmapButton_Tiled_VWrapSizer',
                  'ShapedBitmapButton_Tiled_HWrapSizer',
                  'ShapedBitmapButton_Tiled_VBoxSizer',
                  'ShapedBitmapButton_Tiled_HBoxSizer',
                  'ShapedBitmapButton_Tiled_GridSizer',
                  'ShapedBitmapButton_Normal_HWrapSizer',
                  'ShapedBitmapButton_Normal_HBoxSizer',
                  'ShapedBitmapButton_Normal_AbsolutePositioning',
                  'SmoothMove',
                  ]
...
def GetOverview():
    ...
    """
    docs = wx.lib.mcow.shapedbitmapbutton.__doc__
