...
class ShapedBitmapButtonPanel0(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY,
        ...
        vwSizer = wx.WrapSizer(wx.VERTICAL)
        for i in range(50):
            ...
            vwSizer.Add(btn, p, flags, b)

        self.SetSizer(vwSizer)
...
class TestPanel(wx.Panel):
    def __init__(self, parent, log):
        ...
        b = wx.Button(self, -1, 'Show ShapedBitmapButton Background VWrapSizer Demo', pos=(50, 50))
